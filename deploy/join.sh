...
_load_config_url(){
  ...
  while IFS= read -r line; do
    ...
    case "$k" in
      ...
      CHAIN_ID|GENESIS_URL|GENESIS_SHA256|SEEDS|PERSISTENT_PEERS|DENDRA_NODE|DENDRA_RELAY|FAUCET|EXPLORER_URL|STATESYNC_RPC|STATESYNC_TRUST_HEIGHT|STATESYNC_TRUST_HASH|DENDRA_CAPACITY_URL|CONSENSUS_EPOCH|CONSENSUS_EPOCH_PROVEN)
