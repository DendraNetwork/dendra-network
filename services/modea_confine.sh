...
# hole. The two documents that describe it in full -- docs/MODE-A-SECURITE.md and
# docs/MODE-A-COMPLET.md -- live in the development repository, not in a published tree.
#
# Usage:
