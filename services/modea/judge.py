...
# Change them against a fresh measurement -- judge_calibration.py, in the development repository,
# excluded from published trees by name -- never as a language pass.
PROMPT = (
