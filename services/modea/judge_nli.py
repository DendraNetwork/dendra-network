...
rate becomes a MEASURABLE THRESHOLD PROPERTY (see nli_calibrate.py, in the development repository:
raise the threshold until false
...
def consistency_score(ref, cand):
    ...
    nli_calibrate.py (development repository; calibration tooling is excluded from published
    trees by name) so that false accepts reach zero."""
