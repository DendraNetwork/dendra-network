...
def coherent(text, threshold=None):
    ...
    The threshold comes from DENDRA_PPL_THRESHOLD, calibrated by ppl_calibrate.py
    (development repository; calibration tooling is excluded from published trees by name) with
