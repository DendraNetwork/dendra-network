...
# `dendra_tests_all.sh` -- the project's gate battery, which lives in the development repository
# and is not published -- launches these files as scripts and grades their exit code (phase B);
# they also run under plain `pytest`, which is what a published clone has. pytest
