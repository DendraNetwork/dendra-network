...
incumbent prices below are a SNAPSHOT: their sources and the date each was taken are
recorded in docs/COUT-HONNETE.md, which lives in the development repository and is not
part of a published tree. Re-measure before leaning on them.
"""
...
# Incumbent prices -- $/M OUTPUT tokens. Sources and the date each was taken:
# docs/COUT-HONNETE.md (development repository, not part of a published tree).
INCUMBENTS = {
...
def main():
    ...
    print("   Conclusion: the wedge CANNOT be price. At these rates, undercutting the")
    print("   incumbents is not what this network can sell; a VERIFIABLE answer is.")
