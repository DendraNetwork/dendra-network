...
func TestPlancherValidateurAucunParametreDeChaineDansStaking(t *testing.T) {
...
func TestPlancherValidateurImpliciteEstLaPowerReduction(t *testing.T) {
...
func TestGenesisLivresRespectentLePlancherDeStakeValidateur(t *testing.T) {
...
// vacuous.
func TestPlancherValidateurTientLesDeuxBornes(t *testing.T) {
	for _, nom := range genesisLivres {
		t.Run(nom, func(t *testing.T) {
