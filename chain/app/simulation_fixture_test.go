...
//
//	(A) THE PROPERTY (`TestFixtureGenesisMemeSeedMemeGenesis`). Same seed => same bytes. It knows no
...
func TestFixtureGenesisMemeSeedMemeGenesis(t *testing.T) {
	const repetitions = 8
...
func TestFixtureGenesisTemoinDeuxSeedsDeuxGenesis(t *testing.T) {
