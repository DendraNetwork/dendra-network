...
// end-of-loop `PendingAudit.Remove` — without this, the `(h, jobId)` key would leak into the KV store.
func (k Keeper) deferAuditForSmallJury(ctx context.Context, h int64, jobId string, eligibles, floor int) error {
