...
func TestBarNamingNoReturnOfTheMisleadingName(t *testing.T) {
...
func TestNamingFloorHasASingleConsumer(t *testing.T) {
...
func TestNamingAbsoluteFloorAndRelativeBarAreDistinct(t *testing.T) {
