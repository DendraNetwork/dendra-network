...
// Token bisection — the hash-chain PRIMITIVE. The design it implements is written up in
// docs/DISPUTE-FRAUDPROOF.md §9, which lives in the development repository and is not part of
// a published tree; what binds here is the code below, not that document.
//
...
//
// Precondition measured by `measure_determinism.py` (development repository; measurement
// tooling is excluded from published trees by name): greedy decoding must be
