...
Produced and checked by `dendra_snapshot.sh`, which lives in the development repository and is
not part of a published tree; the reset procedure refuses to run without a valid manifest.
